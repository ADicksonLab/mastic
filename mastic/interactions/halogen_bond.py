"""The HalogenBond module defines the HalogenBondType and
HalogenBondInx for explicit hydrogens.
...
class HalogenBondType(InteractionType):
    ...
    def interaction_constructor(*params, **kwargs):
        return HalogenBondInx(*params, **kwargs)
    ...
    def record(self):
        ...
        HalogenBondTypeRecord = namedtuple('HalogenBondTypeRecord', record_fields)
        ...
        return HalogenBondTypeRecord(**record_attr)
    ...
    def check_distance(distance, cutoff=distance_cutoff):
        ...
        file HALOGEN_BOND_DIST_MAX value.
    ...
    def check_angle(angle, cutoff=angle_cutoff):
        """For a float distance checks if it is less than the configuration
        file HALOGEN_BOND_DON_ANGLE_MIN value.
...
class HalogenBondInx(Interaction):
    """Substantiates HalogenBondType by selecting donor and acceptor
    features, as well as the involved Hydrogen atom.

    """

    interaction_type = HalogenBondType
    ...
    def record(self):
        ...
        HalogenBondInxRecord = namedtuple('HalogenBondInxRecord', record_fields)
        ...
        return HalogenBondInxRecord(**record_attr)
