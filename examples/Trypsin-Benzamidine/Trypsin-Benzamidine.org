...
MAST is agnostic to such decisions.
...
pi_stacking, i.e. in MAST nomenclature it is a commutative interaction.

#+BEGIN_SRC python
  from mast.interactions.pi_stacking import PiStackingType, PiStackingInx
